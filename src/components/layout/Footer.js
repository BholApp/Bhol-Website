  ...
  return (
    <footer style={styles.footer}>
      <div style={styles.footerContent}>
        <div style={styles.footerSection}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem', lineHeight: 1.6, margin: 0 }}>
            Learn Gujarati the way your family speaks.
          </p>
          <div style={styles.socialLinks}>
            ...
            <a href={APP_STORE_URL} style={styles.socialIcon} aria-label="Download on App Store" target="_blank" rel="noopener noreferrer">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div style={styles.footerBottom}>
        <p style={{ margin: 0 }}>&copy; 2025 Bhol. All rights reserved.</p>
      </div>
    </footer>
  );
}
