  ...
  return (
    <header style={styles.header}>
      <nav style={styles.nav}>
        <Link to="/" style={{ ...styles.logo, display: 'flex', alignItems: 'center', gap: '0.75rem' }} onClick={closeMobileMenu}>
          <img
            src="/logo.png"
            alt="Bhol"
            style={{
          ...
          />
          <span style={{ fontSize: '1.75rem' }}>Bhol</span>
        </Link>
        ...
        <ul style={isMobile ? (mobileMenuOpen ? styles.navLinksOpen : { display: 'none' }) : styles.navLinks}>
          ...
          <li>
            <AppStoreBadge height={isMobile ? 36 : 32} />
          </li>
        </ul>
      </nav>
